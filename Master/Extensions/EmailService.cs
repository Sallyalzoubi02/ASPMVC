...
public class EmailService
{
    ...
    public async Task SendEmailAsync(string toEmail, string subject, string message)
    {
        ...
        var senderEmail = emailSettings["SenderEmail"]; // Not "Username"
        var smtpServer = emailSettings["SmtpServer"];
        var port = emailSettings["Port"];
        var password = emailSettings["Password"]; // Not "EmailPassword"
        ...
        {
            throw new InvalidOperationException("Missing EmailSettings values. Required: SenderName, SenderEmail, SmtpServer, Port, Password");
        }
